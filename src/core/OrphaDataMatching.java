...
public class OrphaDataMatching {
    ...
    static final File INDEX_DIR = new File("odmIndex");
        ...
        if (file.canRead() && !file.isDirectory()) {
            ...
            try{
                ...
                while ((line=br.readLine())!=null){
                    ...
                    int m = field.length;
                    for(int i = 0; i<m; i++){
                        symptoms.add(field[i]);
                        //System.out.println("Adding of: "+ field[i]);
                    }
                    ...
                    int i = 0;
                    while (i<n){
                        doc.add(new TextField("Symptom",     symptoms.get(i), 		Field.Store.YES));  // indexed and stored
                        i=i+1;

                    }
                    //System.out.println(doc.getField("Symptom"));
